        ...
        <div className="w-full h-fit flex flex-col items-center justify-start lg:gap-14 gap-8">
          ...
          <div className="w-full h-fit py-10 flex items-center justify-center flex-col gap-3 px-4">
            ...
            <p className="lg:w-[820px] text-center text-balance text-lg  text-slate-600">
              Binge-watching hundreds of clickbait-y tutorials on YouTube.
              Reading hundreds of low-effort blog posts. You're learning a lot,
              but you're also struggling to apply what you've learned to your
              work and projects. Worst of all, uncertainty looms over the next
            ...
            <p className="lg:w-[750px] text-center text-balance text-lg text-slate-600">
              Taught by <HighlightText text="seniors engineers" /> at companies
              like Google and Apple, Learnify courses are{" "}
              <HighlightText text="hyper-focused, project-based tutorials" />{" "}
              that teach students how to build{" "}
            ...
            <p className="lg:w-[750px] text-center text-balance text-lg text-slate-600">
              With over <HighlightText text="500+ hours of video content" />{" "}
              across all Learnify courses, and new courses being released every
              month, you will always find yourself mastering a new library,
              framework or tool.
            </p>
          </div>
          ...
          <div className="w-full h-fit py-10 flex items-center justify-center text-center flex-col gap-3 px-4">
            ...
            <p className="lg:w-[750px] text-center text-balance text-lg text-slate-600">
              ...
              Learnify authors produce{" "}
              <HighlightText text="high-quality content" /> across{" "}
              <HighlightText text="multiple mediums" /> to make learning a
              regular part of your life.
            </p>

            <p className="lg:w-[750px] text-center text-balance text-lg text-slate-600">
              Have a long commute or trip without any reliable internet
              connection options? Download one of the{" "}
              <HighlightText text="15+ books." /> Available in{" "}
              <HighlightText text=" PDF" /> formats for accessibility on any
              device
            </p>
            ...
            <p className="lg:w-[750px] text-center text-balance text-lg text-slate-600">
              ...
              <HighlightText text="3-5 minute" /> shorts and dive into videos,
              each focusing on individual concepts for a compact learning
              experience.
            </p>
          </div>
          ...
          <div className="w-full h-fit py-10 flex items-center justify-center text-center flex-col gap-3 px-4">
            ...
            <p className="lg:w-[955px] text-center text-balance text-lg text-slate-600">
              ...
              <HighlightText text="collaborate with driven individuals" /> like
              you, whether you come with years of industry experience, or you've
              been <HighlightText text="sharing your tech passion" /> through
              YouTube, Codepens, or Medium articles.{" "}
            </p>
            ...
            <p className="lg:w-[955px] text-center text-balance text-lg text-slate-600">
              ...
              course, so you can{" "}
              <HighlightText text="focus on creating amazing content" />{" "}
              Learnify offers various platforms to engage with a{" "}
              <HighlightText
                text="diverse global
            ...
            <p className="lg:w-[955px] text-center text-balance text-lg text-slate-600">
              ...
              we're with you every step of the way, guiding you through the
